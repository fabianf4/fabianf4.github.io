...
const i18n = {
    ...
    'hero-greeting': { en: '<span aria-hidden="true">👋</span> Hi, I\u2019m', es: '<span aria-hidden="true">👋</span> Hola, soy' },
    'hero-tagline': { en: '<span aria-hidden="true">⚡</span> Systems Engineer with experience in enterprise application development and process automation using Power Platform, Python, and SQL Server.', es: '<span aria-hidden="true">⚡</span> Ingeniero de Sistemas con experiencia en desarrollo de aplicaciones empresariales y automatizaci\u00f3n de procesos utilizando Power Platform, Python y SQL Server.' },
    'hero-cta-resume': { en: 'Download Resume', es: 'Descargar HV' },
    'hero-cta-contact': { en: 'Get in touch', es: 'Cont\u00e1ctame' },
    'about-title': { en: '<span aria-hidden="true">🙋</span>\u00a0About me', es: '<span aria-hidden="true">🙋</span>\u00a0Sobre m\u00ed' },
    ...
    'skills-title': { en: '<span aria-hidden="true">🛠️</span>\u00a0Skills', es: '<span aria-hidden="true">🛠️</span>\u00a0Habilidades' },
    ...
    'experience-title': { en: '<span aria-hidden="true">💼</span>\u00a0Experience', es: '<span aria-hidden="true">💼</span>\u00a0Experiencia' },
    ...
    'education-title': { en: '<span aria-hidden="true">🎓</span>\u00a0Education', es: '<span aria-hidden="true">🎓</span>\u00a0Educaci\u00f3n' },
    ...
    'courses-title': { en: '<span aria-hidden="true">📚</span>\u00a0Courses & Training', es: '<span aria-hidden="true">📚</span>\u00a0Cursos y Formaci\u00f3n' },
    ...
    'projects-title': { en: '<span aria-hidden="true">🚀</span>\u00a0Projects', es: '<span aria-hidden="true">🚀</span>\u00a0Proyectos' },
    ...
    'proj-aria-ezskills-repo': { en: 'View ezskills repository on GitHub', es: 'Ver repositorio de ezskills en GitHub' },
    'proj-aria-ezskills-npm': { en: 'View ezskills on npm', es: 'Ver ezskills en npm' },
    'proj-aria-imac-repo': { en: 'View Interelectricas IMAC repository on GitHub', es: 'Ver repositorio de Interelectricas IMAC en GitHub' },
    'proj-aria-imac-live': { en: 'Open Interelectricas IMAC live demo', es: 'Abrir demo de Interelectricas IMAC' },
    'proj-aria-news-repo': { en: 'View News homepage repository on GitHub', es: 'Ver repositorio de News homepage en GitHub' },
    'proj-aria-news-live': { en: 'Open News homepage live demo', es: 'Abrir demo de News homepage' },
    'proj-aria-huddle-repo': { en: 'View Huddle landing page repository on GitHub', es: 'Ver repositorio de Huddle landing page en GitHub' },
    'proj-aria-huddle-live': { en: 'Open Huddle landing page live demo', es: 'Abrir demo de Huddle landing page' },
    'proj-aria-space-repo': { en: 'View Space Tourism Website repository on GitHub', es: 'Ver repositorio de Space Tourism Website en GitHub' },
    'proj-aria-space-live': { en: 'Open Space Tourism Website live demo', es: 'Abrir demo de Space Tourism Website' },
    'social-aria-github': { en: 'Fabian Muñoz on GitHub', es: 'Fabian Muñoz en GitHub' },
    'social-aria-linkedin': { en: 'Fabian Muñoz on LinkedIn', es: 'Fabian Muñoz en LinkedIn' },
    'email-aria': { en: 'Email Fabian Muñoz at fabianfa.munoz@gmail.com', es: 'Escribir a Fabian Muñoz a fabianfa.munoz@gmail.com' },
    'hobbies-title': { en: '<span aria-hidden="true">🎮</span>\u00a0Hobbies', es: '<span aria-hidden="true">🎮</span>\u00a0Pasatiempos' },
    'hobby-1': { en: '<span aria-hidden="true">🎮</span> Play VideoGames', es: '<span aria-hidden="true">🎮</span> Videojuegos' },
    'hobby-2': { en: '<span aria-hidden="true">📺</span> Watch series', es: '<span aria-hidden="true">📺</span> Ver series' },
    'hobby-3': { en: '<span aria-hidden="true">🎵</span> Listen to music', es: '<span aria-hidden="true">🎵</span> Escuchar m\u00fasica' },
    'hobby-4': { en: '<span aria-hidden="true">📖</span> Learn', es: '<span aria-hidden="true">📖</span> Aprender' },
    'hobby-5': { en: '<span aria-hidden="true">💃</span> Dance', es: '<span aria-hidden="true">💃</span> Bailar' },
    'hobby-6': { en: '<span aria-hidden="true">🏊</span> Swim', es: '<span aria-hidden="true">🏊</span> Nadar' },
    'contact-title': { en: '<span aria-hidden="true">✉️</span>\u00a0Contact', es: '<span aria-hidden="true">✉️</span>\u00a0Contacto' },
    'toast-success': { en: '<span aria-hidden="true">✓</span> Thanks for reaching out! I\u2019ll get back to you soon', es: '<span aria-hidden="true">✓</span> \u00a1Gracias por escribirme! Me pondr\u00e9 en contacto contigo pronto' },
    'toast-error': { en: '<span aria-hidden="true">✕</span> Oops, something went wrong. Email me at fabianfa.munoz@gmail.com', es: '<span aria-hidden="true">✕</span> Oops, algo sali\u00f3 mal. Escr\u00edbeme a fabianfa.munoz@gmail.com' },
    ...
    'form-name-error': { en: 'Please enter your name.', es: 'Por favor ingresa tu nombre.' },
    'form-email-error': { en: 'Please enter a valid email address.', es: 'Por favor ingresa un correo electr\u00f3nico v\u00e1lido.' },
    'form-subject-error': { en: 'Please enter a subject.', es: 'Por favor ingresa un asunto.' },
    'form-message-error': { en: 'Please enter a message.', es: 'Por favor ingresa un mensaje.' },
    'form-status-invalid': { en: 'Please review the highlighted fields and try again.', es: 'Por favor revisa los campos resaltados e intenta de nuevo.' },
    'contact-direct': { en: 'Or email me directly:', es: 'O escr\u00edbeme directamente:' },
    'footer-text': { en: 'Made with <span aria-hidden="true">❤️</span> by Fabian Esteban Mu\u00f1oz Lopez', es: 'Hecho con <span aria-hidden="true">❤️</span> por Fabian Esteban Mu\u00f1oz Lopez' }
};

// Cambia el idioma de la página (en/es)
// Actualiza textos via data-i18n (textContent) o data-i18n-html (innerHTML,
// para claves que contienen <span aria-hidden> envolviendo emojis),
// atributos aria-label via data-i18n-aria, configura el botón de descarga
// de HV, persiste en localStorage y actualiza el botón de cambio de idioma
